...
const navItems = [
  ...
  { label: 'Receipts', id: 'receipts', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
...
const POSView = memo(function POSView({ onSaleComplete, onBackToDashboard, pharmacyName }) {
  return (
    <div className="dashboard-shell">
      ...
      <SalesPos onSaleComplete={onSaleComplete} onBackToDashboard={onBackToDashboard} />
    </div>
  );
});
  ...
  if (view === 'pos') {
    return (
      <POSView
        ...
        pharmacyName={authState.user?.pharmacyName}
      />
    )
  }
  ...
  return (
    <div className="dashboard-shell">
      ...
      <main className="main-content">
          ...
          <div className="page-section" id="receipts">
            {renderedSections.has('receipts') && (
              <Suspense fallback={<PageLoader />}>
                <ReceiptHistory />
              </Suspense>
            )}
