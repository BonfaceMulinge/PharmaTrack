...
function App() {
  ...
  return (
    <Routes>
      <Route element={<DashboardLayout user={authState.user} onLogout={handleLogout} />}>
        <Route index element={<HomePage />} />
        <Route path="medicines" element={<MedicineManagement />} />
        <Route path="sales" element={<SalesPos onSaleComplete={handleSaleComplete} />} />
        <Route path="receipts" element={<ReceiptHistory />} />
        <Route path="notifications" element={<NotificationsForecasting />} />
      </Route>
